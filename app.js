...
app.get("/posts/:postId", function (req, res) {
  //this will give the url of title for eg LocalHost:3000/posts/Day 2
  // const requestedTittle = _.lowerCase(req.params.postName);      //with the help of loadash text wrap into lowercase
